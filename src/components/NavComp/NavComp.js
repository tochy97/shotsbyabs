...
import { Navbar, Container, Offcanvas, Form, Nav, Button, Image, Alert } from "react-bootstrap";
...
function NavComp() {
    ...
    return (
      ...
      <Container fluid>
        ...
        <Navbar.Toggle aria-controls="offcanvasNavbar" style={{marginRight:"2rem", border:0, color:"#039374"}}>Admin</Navbar.Toggle> 
            ...
            ?
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  <Nav.Link style={{color:"black"}} href="/admin/add">Adder</Nav.Link>
